...
public class FrozenSkeleton {

    static String name = "&bFrozen Skeleton";
    static EntityType entityType = EntityType.STRAY;
    static double healthMultiplier = 0.6;
    static double goldDropMultiplier = 0.8;
